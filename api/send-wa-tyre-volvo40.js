export default async function handler(req, res) {
  ...
  function formatMessage(data) {
    const {
        tanggal, nowo, unit, lokasi, operator, hoursmeters, lokasipengerjaan, problem, tyresize, action, posisid1, jeniskerusakand1, penyebabkerusakand1, brandd1, patternd1, snd1, rtdd1, tyrestatusd1, tubestatusd1, flapstatusd1, posisim1, brandm1, patternm1, snm1, psim1, rtdm1, tyrestatusm1, tubestatusm1, flapstatusm1, posisid2, jeniskerusakand2, penyebabkerusakand2, brandd2, patternd2, snd2, rtdd2, tyrestatusd2, tubestatusd2, flapstatusd2, posisim2, brandm2, patternm2, snm2, psim2, rtdm2, tyrestatusm2, tubestatusm2, flapstatusm2, posisid3, jeniskerusakand3, penyebabkerusakand3, brandd3, patternd3, snd3, rtdd3, tyrestatusd3, tubestatusd3, flapstatusd3, posisim3, brandm3, patternm3, snm3, psim3, rtdm3, tyrestatusm3, tubestatusm3, flapstatusm3, delay, startpengerjaan, finishpengerjaan, status, pendingjob, manpower, supervisor
    } = data;
